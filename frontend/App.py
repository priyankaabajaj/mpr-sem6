...
def spell():
    if request.method == 'POST':
        ...
        return render_template('Grammar.html', corrected_text=corrected_text, corrected_grammar=corrected_grammar)
...
def grammar():
    if request.method == 'POST':
        ...
        return render_template('Grammar.html', corrected_file_text=corrected_file_text, corrected_file_grammar=corrected_file_grammar)
